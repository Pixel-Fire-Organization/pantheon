...
const menu = {
    ...
    'Menu/File/Save as...': {
        path: ['File', 'Save Document as...'],
        shortcut: [{key: 'S', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/File/Export/Wavefront OBJ...': {
        path: ['File', 'Export', 'Wavefront OBJ...'],
    ...
    'Menu/File/Reload Material Collections': {
        path: ['File', 'Reload Material Collections'],
        shortcut: [{key: 'F5', modifiers: []}]
    },
    'Menu/File/Reload Entity Definitions': {
        path: ['File', 'Reload Entity Definitions'],
        shortcut: [{key: 'F6', modifiers: []}]
    },
    ...
    'Menu/Edit/Clear Repeatable Commands': {
        path: ['Edit', 'Clear Repeatable Commands'],
    ...
    'Menu/Edit/Paste at Original Position': {
        path: ['Edit', 'Paste at Original Position'],
        shortcut: [{key: 'V', modifiers: ['Ctrl', 'Alt',]}]
    },
    ...
    'Controls/Map view/Flip objects horizontally': {
        path: ['Edit', 'Transform', 'Flip Horizontally'],
        shortcut: [{key: 'F', modifiers: ['Ctrl',]}]
    },
    'Controls/Map view/Flip objects vertically': {
        path: ['Edit', 'Transform', 'Flip Vertically'],
        shortcut: [{key: 'F', modifiers: ['Ctrl', 'Alt',]}]
    },
    'Menu/Edit/Move objects': {
        path: ['Edit', 'Transform', 'Move...'],
        shortcut: [{key: 'M', modifiers: ['Ctrl', 'Alt',]}]
    },
    ...
    'Menu/Edit/Snap Vertices to Integer': {
        path: ['Edit', 'Vertices', 'Snap Vertices to Integer'],
        shortcut: [{key: 'V', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/Edit/Snap Vertices to Grid': {
        path: ['Edit', 'Vertices', 'Snap Vertices to Grid'],
        shortcut: [{key: 'V', modifiers: ['Ctrl', 'Alt', 'Shift',]}]
    },
    'Menu/Edit/Convert Selection to Patches': {
        path: ['Edit', 'Patches', 'Convert Selection to Patches'],
        shortcut: [{key: 'P', modifiers: ['Ctrl',]}]
    },
    'Menu/Edit/Texture Lock': {path: ['Edit', 'Textures', 'Texture Lock'], shortcut: [{key: '', modifiers: []}]},
    'Menu/Edit/UV Lock': {path: ['Edit', 'Textures', 'UV Lock'], shortcut: [{key: 'U', modifiers: []}]},
    'Menu/Edit/Replace Material...': {
        path: ['Edit', 'Textures', 'Replace Material...'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/Edit/Select All': {path: ['Selection', 'Select All'], shortcut: [{key: 'A', modifiers: ['Ctrl',]}]},
    'Menu/Edit/Invert Selection': {
        path: ['Selection', 'Invert Selection'],
        shortcut: [{key: 'A', modifiers: ['Ctrl', 'Alt',]}]
    },
    'Menu/Edit/Deselect All': {
        path: ['Selection', 'Deselect All'],
        shortcut: [{key: 'A', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/Edit/Select Siblings': {path: ['Selection', 'Select Siblings'], shortcut: [{key: 'B', modifiers: ['Ctrl',]}]},
    'Menu/Edit/Select Touching': {path: ['Selection', 'Select Touching'], shortcut: [{key: 'T', modifiers: ['Ctrl',]}]},
    'Menu/Edit/Select Inside': {path: ['Selection', 'Select Inside'], shortcut: [{key: 'E', modifiers: ['Ctrl',]}]},
    'Menu/Edit/Select Tall': {
        path: ['Selection', 'Select Tall'],
        shortcut: [{key: 'E', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/Edit/Select by Line Number': {
        path: ['Selection', 'Select by Line Number...'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/Edit/Group': {path: ['Groups', 'Group Selected Objects'], shortcut: [{key: 'G', modifiers: ['Ctrl',]}]},
    'Menu/Edit/Ungroup': {
        path: ['Groups', 'Ungroup Selected Objects'],
        shortcut: [{key: 'G', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/Edit/Rename Groups': {
        path: ['Groups', 'Rename Selected Groups'],
        shortcut: [{key: 'G', modifiers: ['Ctrl', 'Alt',]}]
    },
    'Menu/Edit/Create Linked Duplicate': {
        path: ['Groups', 'Create Linked Duplicate'],
        shortcut: [{key: 'D', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/Edit/Select Linked Groups': {path: ['Groups', 'Select Linked Groups'], shortcut: [{key: '', modifiers: []}]},
    'Menu/Edit/Separate Linked Groups': {
        path: ['Groups', 'Separate Selected Groups'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/Edit/Extract Linked Groups': {
        path: ['Groups', 'Extract Selected Objects'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/Edit/Clear Protected Properties': {
        path: ['Groups', 'Clear Protected Properties'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/Edit/Tools/Brush Tool': {path: ['Tools', 'Brush Tool'], shortcut: [{key: 'B', modifiers: []}]},
    'Menu/Edit/Tools/Clip Tool': {path: ['Tools', 'Clip Tool'], shortcut: [{key: 'C', modifiers: []}]},
    'Menu/Edit/Tools/Rotate Tool': {path: ['Tools', 'Rotate Tool'], shortcut: [{key: 'R', modifiers: []}]},
    'Menu/Edit/Tools/Sweep Tool': {path: ['Tools', 'Sweep Tool'], shortcut: [{key: 'Y', modifiers: []}]},
    'Menu/Edit/Tools/Scale Tool': {path: ['Tools', 'Scale Tool'], shortcut: [{key: 'T', modifiers: []}]},
    'Menu/Edit/Tools/Shear Tool': {path: ['Tools', 'Shear Tool'], shortcut: [{key: 'G', modifiers: []}]},
    'Menu/Edit/Tools/Vertex Tool': {path: ['Tools', 'Vertex Tool'], shortcut: [{key: 'V', modifiers: []}]},
    'Menu/Edit/Tools/Edge Tool': {path: ['Tools', 'Edge Tool'], shortcut: [{key: 'E', modifiers: []}]},
    'Menu/Edit/Tools/Face Tool': {path: ['Tools', 'Face Tool'], shortcut: [{key: 'F', modifiers: []}]},
    'Menu/Edit/Tools/Control Point Tool': {
        path: ['Tools', 'Control Point Tool'],
        shortcut: [{key: 'P', modifiers: []}]
    },
    'Controls/Map view/Deactivate current tool': {
        path: ['Tools', 'Deactivate Current Tool'],
        shortcut: [{key: 'Esc', modifiers: ['Shift',]}]
    },
    ...
    'Menu/View/Grid/Snap to Grid': {
        ...
        shortcut: [{key: '0', modifiers: ['Alt',]}]
    },
    'Menu/View/Grid/Increase Grid Size': {
        path: ['View', 'Grid', 'Increase Grid Size'],
        shortcut: [{key: '+', modifiers: []}]
    },
    'Menu/View/Grid/Decrease Grid Size': {
        path: ['View', 'Grid', 'Decrease Grid Size'],
        shortcut: [{key: '-', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 0.125': {
        path: ['View', 'Grid', 'Set Grid Size 0.125'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 0.25': {
        path: ['View', 'Grid', 'Set Grid Size 0.25'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 0.5': {
        path: ['View', 'Grid', 'Set Grid Size 0.5'],
        shortcut: [{key: '', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 1': {
        path: ['View', 'Grid', 'Set Grid Size 1'],
        shortcut: [{key: '1', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 2': {
        path: ['View', 'Grid', 'Set Grid Size 2'],
        shortcut: [{key: '2', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 4': {
        path: ['View', 'Grid', 'Set Grid Size 4'],
        shortcut: [{key: '3', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 8': {
        path: ['View', 'Grid', 'Set Grid Size 8'],
        shortcut: [{key: '4', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 16': {
        path: ['View', 'Grid', 'Set Grid Size 16'],
        shortcut: [{key: '5', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 32': {
        path: ['View', 'Grid', 'Set Grid Size 32'],
        shortcut: [{key: '6', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 64': {
        path: ['View', 'Grid', 'Set Grid Size 64'],
        shortcut: [{key: '7', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 128': {
        path: ['View', 'Grid', 'Set Grid Size 128'],
        shortcut: [{key: '8', modifiers: []}]
    },
    'Menu/View/Grid/Set Grid Size 256': {
        path: ['View', 'Grid', 'Set Grid Size 256'],
        shortcut: [{key: '9', modifiers: []}]
    },
    'Menu/View/Camera/Move to Next Point': {
        path: ['View', 'Camera', 'Move Camera to Next Point'],
        shortcut: [{key: '.', modifiers: []}]
    },
    'Menu/View/Camera/Move to Previous Point': {
        path: ['View', 'Camera', 'Move Camera to Previous Point'],
        shortcut: [{key: ',', modifiers: []}]
    },
    'Menu/View/Camera/Reset 2D Cameras': {
        path: ['View', 'Camera', 'Reset 2D Cameras'],
        shortcut: [{key: 'U', modifiers: ['Ctrl', 'Shift',]}]
    },
    'Menu/View/Camera/Focus on Selection': {
        path: ['View', 'Camera', 'Focus Camera on Selection'],
        shortcut: [{key: 'U', modifiers: ['Ctrl',]}]
    },
    'Menu/View/Camera/Move Camera to...': {
        path: ['View', 'Camera', 'Move Camera to...'],
        shortcut: [{key: '', modifiers: []}]
    },
    ...
    'Menu/View/Switch to Map Inspector': {
        path: ['View', 'Show Map Inspector'],
        shortcut: [{key: '1', modifiers: ['Ctrl',]}]
    },
    'Menu/View/Switch to Entity Inspector': {
        path: ['View', 'Show Entity Inspector'],
        shortcut: [{key: '2', modifiers: ['Ctrl',]}]
    },
    'Menu/View/Switch to Face Inspector': {
        path: ['View', 'Show Face Inspector'],
        shortcut: [{key: '3', modifiers: ['Ctrl',]}]
    },
    ...
    'Menu/View/Maximize Current View': {
        path: ['View', 'Maximize Current View'],
        shortcut: [{key: 'Space', modifiers: ['Ctrl',]}]
    },
    'Menu/File/Preferences...': {path: ['View', 'Preferences...'], shortcut: [{key: 'Settings', modifiers: []}]},
    ...
    'Menu/Run/Rerun...': {path: ['Run', 'Re-run compilation...'], shortcut: [{key: '', modifiers: []}]},
...
const actions = {
    ...
    'Menu/Edit/Tools/Control Point Tool': [{key: 'P', modifiers: []}],
    'Menu/Edit/Tools/Rotate Tool': [{key: 'R', modifiers: []}],
    'Menu/Edit/Tools/Sweep Tool': [{key: 'Y', modifiers: []}],
    ...
    'Controls/Map view/Perform sweep': [{key: 'Return', modifiers: []}],
    'Controls/Map view/Move objects up; Move objects forward': [{key: 'Up', modifiers: []}],
    'Controls/Map view/Decrease sweep scale': [{key: '[', modifiers: []}],
    'Controls/Map view/Increase sweep scale': [{key: ']', modifiers: []}],
